...
public class BusinessProcessParameters2dcd9a4882b210000f7b2e0a85982265 {
  ...
  public BusinessProcessParameters2dcd9a4882b210000f7b2e0a85982265() {
  }
  ...
  public BusinessProcessParameters2dcd9a4882b210000f7b2e0a85982265 action(Action38ff08ab6736100010816009079d0126 action) {
  ...
  **/
  ...
  public BusinessProcessParameters2dcd9a4882b210000f7b2e0a85982265 overallBusinessProcess(OverallBusinessProcess5d688bd57bb910001815ab49927724aa overallBusinessProcess) {
  ...
  **/
  ...
  public BusinessProcessParameters2dcd9a4882b210000f7b2e0a85982265 comment(String comment) {
  ...
  **/
  ...
  public BusinessProcessParameters2dcd9a4882b210000f7b2e0a85982265 transactionStatus(TransactionStatus7457adcbe0fa1000089b63ab3a510000 transactionStatus) {
  ...
  **/
  ...
  public BusinessProcessParameters2dcd9a4882b210000f7b2e0a85982265 attachments(List<EventAttachmentsForToolbar43b30ba735b8100011ee4767246d0143> attachments) {
  ...
  public BusinessProcessParameters2dcd9a4882b210000f7b2e0a85982265 addAttachmentsItem(EventAttachmentsForToolbar43b30ba735b8100011ee4767246d0143 attachmentsItem) {
  ...
  **/
  ...
  public BusinessProcessParameters2dcd9a4882b210000f7b2e0a85982265 _for(For5d688bd57bb910001815ab3dd10024a9 _for) {
  ...
  **/
   ...
   * @return the BusinessProcessParameters2dcd9a4882b210000f7b2e0a85982265 instance itself
   */
  public BusinessProcessParameters2dcd9a4882b210000f7b2e0a85982265 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BusinessProcessParameters2dcd9a4882b210000f7b2e0a85982265 businessProcessParameters2dcd9a4882b210000f7b2e0a85982265 = (BusinessProcessParameters2dcd9a4882b210000f7b2e0a85982265) o;
    return Objects.equals(this.action, businessProcessParameters2dcd9a4882b210000f7b2e0a85982265.action) &&
        Objects.equals(this.overallBusinessProcess, businessProcessParameters2dcd9a4882b210000f7b2e0a85982265.overallBusinessProcess) &&
        Objects.equals(this.comment, businessProcessParameters2dcd9a4882b210000f7b2e0a85982265.comment) &&
        Objects.equals(this.comments, businessProcessParameters2dcd9a4882b210000f7b2e0a85982265.comments) &&
        Objects.equals(this.transactionStatus, businessProcessParameters2dcd9a4882b210000f7b2e0a85982265.transactionStatus) &&
        Objects.equals(this.warningValidations, businessProcessParameters2dcd9a4882b210000f7b2e0a85982265.warningValidations) &&
        Objects.equals(this.overallStatus, businessProcessParameters2dcd9a4882b210000f7b2e0a85982265.overallStatus) &&
        Objects.equals(this.attachments, businessProcessParameters2dcd9a4882b210000f7b2e0a85982265.attachments) &&
        Objects.equals(this.criticalValidations, businessProcessParameters2dcd9a4882b210000f7b2e0a85982265.criticalValidations) &&
        Objects.equals(this._for, businessProcessParameters2dcd9a4882b210000f7b2e0a85982265._for)&&
        Objects.equals(this.additionalProperties, businessProcessParameters2dcd9a4882b210000f7b2e0a85982265.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class BusinessProcessParameters2dcd9a4882b210000f7b2e0a85982265 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to BusinessProcessParameters2dcd9a4882b210000f7b2e0a85982265
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BusinessProcessParameters2dcd9a4882b210000f7b2e0a85982265.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BusinessProcessParameters2dcd9a4882b210000f7b2e0a85982265 is not found in the empty JSON string", BusinessProcessParameters2dcd9a4882b210000f7b2e0a85982265.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BusinessProcessParameters2dcd9a4882b210000f7b2e0a85982265.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BusinessProcessParameters2dcd9a4882b210000f7b2e0a85982265.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BusinessProcessParameters2dcd9a4882b210000f7b2e0a85982265' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BusinessProcessParameters2dcd9a4882b210000f7b2e0a85982265> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BusinessProcessParameters2dcd9a4882b210000f7b2e0a85982265.class));

       return (TypeAdapter<T>) new TypeAdapter<BusinessProcessParameters2dcd9a4882b210000f7b2e0a85982265>() {
           @Override
           public void write(JsonWriter out, BusinessProcessParameters2dcd9a4882b210000f7b2e0a85982265 value) throws IOException {
           ...
           @Override
           public BusinessProcessParameters2dcd9a4882b210000f7b2e0a85982265 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BusinessProcessParameters2dcd9a4882b210000f7b2e0a85982265 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BusinessProcessParameters2dcd9a4882b210000f7b2e0a85982265 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BusinessProcessParameters2dcd9a4882b210000f7b2e0a85982265
  * @throws IOException if the JSON string is invalid with respect to BusinessProcessParameters2dcd9a4882b210000f7b2e0a85982265
  */
  public static BusinessProcessParameters2dcd9a4882b210000f7b2e0a85982265 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BusinessProcessParameters2dcd9a4882b210000f7b2e0a85982265.class);
  }

 /**
  * Convert an instance of BusinessProcessParameters2dcd9a4882b210000f7b2e0a85982265 to an JSON string
  *
  * @return JSON string
  */
