...
public class BusinessProcessParameters5afc0b4b5a4610002aaebb8180cd2261 {
  ...
  public BusinessProcessParameters5afc0b4b5a4610002aaebb8180cd2261() {
  }
  ...
  public BusinessProcessParameters5afc0b4b5a4610002aaebb8180cd2261 action(Action38ff08ab6736100010816009079d0126 action) {
  ...
  **/
  ...
  public BusinessProcessParameters5afc0b4b5a4610002aaebb8180cd2261 overallBusinessProcess(OverallBusinessProcess5d688bd57bb910001815ab49927724aa overallBusinessProcess) {
  ...
  **/
  ...
  public BusinessProcessParameters5afc0b4b5a4610002aaebb8180cd2261 comment(String comment) {
  ...
  **/
  ...
  public BusinessProcessParameters5afc0b4b5a4610002aaebb8180cd2261 transactionStatus(TransactionStatus7457adcbe0fa1000089b63ab3a510000 transactionStatus) {
  ...
  **/
  ...
  public BusinessProcessParameters5afc0b4b5a4610002aaebb8180cd2261 attachments(List<EventAttachmentsForToolbar43b30ba735b8100011ee4767246d0143> attachments) {
  ...
  public BusinessProcessParameters5afc0b4b5a4610002aaebb8180cd2261 addAttachmentsItem(EventAttachmentsForToolbar43b30ba735b8100011ee4767246d0143 attachmentsItem) {
  ...
  **/
  ...
  public BusinessProcessParameters5afc0b4b5a4610002aaebb8180cd2261 _for(For5d688bd57bb910001815ab3dd10024a9 _for) {
  ...
  **/
   ...
   * @return the BusinessProcessParameters5afc0b4b5a4610002aaebb8180cd2261 instance itself
   */
  public BusinessProcessParameters5afc0b4b5a4610002aaebb8180cd2261 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BusinessProcessParameters5afc0b4b5a4610002aaebb8180cd2261 businessProcessParameters5afc0b4b5a4610002aaebb8180cd2261 = (BusinessProcessParameters5afc0b4b5a4610002aaebb8180cd2261) o;
    return Objects.equals(this.action, businessProcessParameters5afc0b4b5a4610002aaebb8180cd2261.action) &&
        Objects.equals(this.overallBusinessProcess, businessProcessParameters5afc0b4b5a4610002aaebb8180cd2261.overallBusinessProcess) &&
        Objects.equals(this.comment, businessProcessParameters5afc0b4b5a4610002aaebb8180cd2261.comment) &&
        Objects.equals(this.comments, businessProcessParameters5afc0b4b5a4610002aaebb8180cd2261.comments) &&
        Objects.equals(this.transactionStatus, businessProcessParameters5afc0b4b5a4610002aaebb8180cd2261.transactionStatus) &&
        Objects.equals(this.warningValidations, businessProcessParameters5afc0b4b5a4610002aaebb8180cd2261.warningValidations) &&
        Objects.equals(this.overallStatus, businessProcessParameters5afc0b4b5a4610002aaebb8180cd2261.overallStatus) &&
        Objects.equals(this.attachments, businessProcessParameters5afc0b4b5a4610002aaebb8180cd2261.attachments) &&
        Objects.equals(this.criticalValidations, businessProcessParameters5afc0b4b5a4610002aaebb8180cd2261.criticalValidations) &&
        Objects.equals(this._for, businessProcessParameters5afc0b4b5a4610002aaebb8180cd2261._for)&&
        Objects.equals(this.additionalProperties, businessProcessParameters5afc0b4b5a4610002aaebb8180cd2261.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class BusinessProcessParameters5afc0b4b5a4610002aaebb8180cd2261 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to BusinessProcessParameters5afc0b4b5a4610002aaebb8180cd2261
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BusinessProcessParameters5afc0b4b5a4610002aaebb8180cd2261.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BusinessProcessParameters5afc0b4b5a4610002aaebb8180cd2261 is not found in the empty JSON string", BusinessProcessParameters5afc0b4b5a4610002aaebb8180cd2261.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BusinessProcessParameters5afc0b4b5a4610002aaebb8180cd2261.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BusinessProcessParameters5afc0b4b5a4610002aaebb8180cd2261.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BusinessProcessParameters5afc0b4b5a4610002aaebb8180cd2261' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BusinessProcessParameters5afc0b4b5a4610002aaebb8180cd2261> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BusinessProcessParameters5afc0b4b5a4610002aaebb8180cd2261.class));

       return (TypeAdapter<T>) new TypeAdapter<BusinessProcessParameters5afc0b4b5a4610002aaebb8180cd2261>() {
           @Override
           public void write(JsonWriter out, BusinessProcessParameters5afc0b4b5a4610002aaebb8180cd2261 value) throws IOException {
           ...
           @Override
           public BusinessProcessParameters5afc0b4b5a4610002aaebb8180cd2261 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BusinessProcessParameters5afc0b4b5a4610002aaebb8180cd2261 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BusinessProcessParameters5afc0b4b5a4610002aaebb8180cd2261 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BusinessProcessParameters5afc0b4b5a4610002aaebb8180cd2261
  * @throws IOException if the JSON string is invalid with respect to BusinessProcessParameters5afc0b4b5a4610002aaebb8180cd2261
  */
  public static BusinessProcessParameters5afc0b4b5a4610002aaebb8180cd2261 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BusinessProcessParameters5afc0b4b5a4610002aaebb8180cd2261.class);
  }

 /**
  * Convert an instance of BusinessProcessParameters5afc0b4b5a4610002aaebb8180cd2261 to an JSON string
  *
  * @return JSON string
  */
