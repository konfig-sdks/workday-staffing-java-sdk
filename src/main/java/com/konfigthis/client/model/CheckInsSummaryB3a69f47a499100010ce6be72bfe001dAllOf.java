...
public class CheckInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf {
  ...
  public CheckInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf() {
  }

  public CheckInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf description(String description) {
  ...
  **/
  ...
  public CheckInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf associatedTopics(List<AssociatedTopicsSummaryB3a69f47a4991000171aae4c5a810040> associatedTopics) {
  ...
  public CheckInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf addAssociatedTopicsItem(AssociatedTopicsSummaryB3a69f47a4991000171aae4c5a810040 associatedTopicsItem) {
  ...
  **/
  ...
  public CheckInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf creator(CreatorB3a69f47a49910001687de28dd71003d creator) {
  ...
  **/
  ...
  public CheckInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf archived(Boolean archived) {
  ...
  **/
  ...
  public CheckInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf checkInAttachments(List<CheckInAttachmentDetailEf244acfe6cf10002ebe92d43a7701d7> checkInAttachments) {
  ...
  public CheckInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf addCheckInAttachmentsItem(CheckInAttachmentDetailEf244acfe6cf10002ebe92d43a7701d7 checkInAttachmentsItem) {
  ...
  **/
  ...
  public CheckInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf participant(ParticipantB3a69f47a49910001687de1d4c75003c participant) {
  ...
  **/
  ...
  public CheckInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf date(LocalDate date) {
  ...
  **/
  ...
  public CheckInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf id(String id) {
  ...
  **/
   ...
   * @return the CheckInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf instance itself
   */
  public CheckInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CheckInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf checkInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf = (CheckInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf) o;
    return Objects.equals(this.description, checkInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf.description) &&
        Objects.equals(this.associatedTopics, checkInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf.associatedTopics) &&
        Objects.equals(this.creator, checkInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf.creator) &&
        Objects.equals(this.archived, checkInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf.archived) &&
        Objects.equals(this.checkInAttachments, checkInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf.checkInAttachments) &&
        Objects.equals(this.participant, checkInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf.participant) &&
        Objects.equals(this.date, checkInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf.date) &&
        Objects.equals(this.id, checkInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf.id)&&
        Objects.equals(this.additionalProperties, checkInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CheckInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CheckInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CheckInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CheckInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf is not found in the empty JSON string", CheckInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CheckInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CheckInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CheckInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CheckInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<CheckInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf>() {
           @Override
           public void write(JsonWriter out, CheckInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf value) throws IOException {
           ...
           @Override
           public CheckInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CheckInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CheckInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CheckInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf
  * @throws IOException if the JSON string is invalid with respect to CheckInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf
  */
  public static CheckInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CheckInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf.class);
  }

 /**
  * Convert an instance of CheckInsSummaryB3a69f47a499100010ce6be72bfe001dAllOf to an JSON string
  *
  * @return JSON string
  */
