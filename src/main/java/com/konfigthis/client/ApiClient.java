...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://<tenantHostname>/staffing/v6";
    ...
    private RetryingOAuth setupOauth(String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        RetryingOAuth oauth = new RetryingOAuth(getTokenUrl(), clientId, OAuthFlow.IMPLICIT, clientSecret, parameters);
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://<tenantHostname>/staffing/v6)
     ...
     * Set token url
     *
     * @param tokenUrl Token URL for oauth (e.g )
     * @return An instance of OkHttpClient
     */
